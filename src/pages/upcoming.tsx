      ...
      <div>
        ...
        <div className="relative">
          {data.allScheduledEvent.edges.map(({ node }) => {
            ...
            return (
              <div className="text-gray-50 shadow bg-blue-700 m-4 p-4 rounded flex flex-col" key={node.id}>
                <h3 className=" text-xl font-sans capitalize">{node.name}</h3>
                <h4 className="text-base font-sans font-light">
